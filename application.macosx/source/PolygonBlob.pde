class PolygonBlob extends Polygon2D {
  ...
  void createPolygon() {    // an ArrayList of the ArrayLists of PVectors, which is basically the person's contours (almost but not completely in a polygon-correct order)
  ...
  void createBody() {    // creates a shape-deflecting physics chain in the box2d world from this polygon
